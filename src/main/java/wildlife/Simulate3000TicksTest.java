...
public class Simulate3000TicksTest {

    public static void main(String[] args) {
        System.out.println("=== SIMULATE 3000 TICKS (~ 100 giay thuc te @ 30 tick/s) ===\n");

        CompositeMap world = MapLoader.loadMapFromFile("sim-3000", "Sim 3000", "config/map.txt");
        ...
        for (String species : order) {
            ...
            else if (end > start * 4)  flag = "  << BU PHAT";
